...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Common.internal_static_qhx_proto_weve_DoubleList_descriptor;
  }

  @Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Common.internal_static_qhx_proto_weve_DoubleList_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            DoubleList.class, Builder.class);
  }
  ...
  public static DoubleList parseFrom(
  ...
  public static DoubleList parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DoubleList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static DoubleList parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(DoubleList prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.qhx.proto.event.DoubleList.newBuilder()
    private Builder() {
    ...
    public DoubleList build() {
      DoubleList result = buildPartial();
    ...
    public DoubleList buildPartial() {
      DoubleList result = new DoubleList(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DoubleList) {
        return mergeFrom((DoubleList)other);
      } else {
    ...
    public Builder mergeFrom(DoubleList other) {
      if (other == DoubleList.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      DoubleList parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (DoubleList) e.getUnfinishedMessage();
  ...
  private static final DoubleList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DoubleList();
  }
